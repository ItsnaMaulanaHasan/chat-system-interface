      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-base font-semibold loading-7 text-gray-900">Create a group chat</h2>
            <p className="mt-1 text-sm loading-6 text-gray-600">Create a chat with more than 2 people</p>
